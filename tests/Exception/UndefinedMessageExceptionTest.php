...
class UndefinedMessageExceptionTest extends TestCase
{
    public function testException()
    {
        ...
        $e = new UndefinedMessageException(
            channel: 'name',
        ...
        $this->assertSame(
            'Notification Tobento\Service\Notifier\Notification has no message for the channel name defined',
            $e->getMessage()
        );
        
        $this->assertSame(
            'Custom',
            (new UndefinedMessageException(
                channel: 'name',
                notification: $notification,
                recipient: $recipient,
                message: 'Custom',
